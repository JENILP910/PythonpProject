...
SECRET_KEY = '&8zxmz97u44@i(2r_ibti=kw55a-&y&ewvfmnd#fwvjpnq67!7'
...
DATABASES = {
    ...
    'NAME' : 'ce050' , # Name of the database*
    'USER': 'ce050', #user name for the database
    'PASSWORD' : 'ce050', # password
